...
@Getter
@NoArgsConstructor
public class SearchTagChallengeResponse {
    ...
    private List<SearchTagPostResponse> postList;
    private boolean isSubscription;


    public SearchTagChallengeResponse(Challenge challenge, List<SearchTagPostResponse> postList, boolean isSubscription) {
