...
public class PostApiController {
    ...
    public Result testPersonalize(@PathVariable("userNo") int userNo){
        final String USAGE = "\n" +
                "Usage:\n" +
        ...
        String campaignArn = "arn:aws:personalize:ap-northeast-2:362595014566:campaign/challympic-campaign2";
        String userId = String.valueOf(userNo);
        ArrayList<String> items = new ArrayList<>(Arrays.asList(userId.split("\\s*,\\s*")));
